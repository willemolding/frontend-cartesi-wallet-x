                ...
                <TabPanels>
                    ...
                    <Accordion size='xl' defaultIndex={[0]} allowMultiple>
                        <AccordionItem>
                            ...
                            <AccordionPanel>
                            <Stack>
                                <NumberInput defaultValue={0} min={0} onChange={(value) => setEtherAmount(Number(value))} value={etherAmount} >
                                    <NumberInputField />
                                    <NumberInputStepper>
                                        <NumberIncrementStepper />
                                        <NumberDecrementStepper />
                                ...
                                <Button colorScheme='blue' size='sm' onClick={() => {
                                        depositEtherToPortal(etherAmount)}} disabled={!rollups}>
                                    Deposit
                                </Button>
                                <Button size='sm' onClick={() => {
                                        withdrawEther(etherAmount)}} disabled={!rollups}>
                                    Withdraw
                                </Button>
                        ...
                        <AccordionItem>
                            ...
                            <AccordionPanel>
                            <Stack>
                            <Input type='text' variant='outline' placeholder='Address' onChange={(e) => setErc20Token(String(e.target.value))} value={erc20Token}/>
                            <Input type='number' variant='outline' placeholder='Amount' onChange={(e) => setErc20Amount(Number(e.target.value))} value={erc20Amount}/>
                            {/*
                            Deposit ERC20 <br />
                            Address: <input
                                type="text"
                        ...
                        <AccordionItem>
                            ...
                            <AccordionPanel>
                            <Stack>
                            <Input type='text' variant='outline' placeholder='Address' onChange={(e) => setErc721(String(e.target.value))} value={erc721}/>
                            <Input type='number' variant='outline' placeholder='ID' onChange={(e) => setErc721Id(Number(e.target.value))} value={erc721Id}/>
                            {/* 
                            Address: <input
                                type="text"
                                value={erc721}
                            ...
                            /> 
                            */}
                            <Button colorScheme='blue' size='sm' onClick={() => transferNftToPortal(erc721,erc721Id)} disabled={!rollups}>
                                Transfer
                            </Button>
                            <Button size='sm' onClick={() => {
                                        withdrawErc721(erc721, erc721Id)}} disabled={!rollups}>
                            Withdraw
                            </Button>
                            <br /><br />
                            </Stack>
                    ...
                    <Accordion defaultIndex={[0]} allowMultiple>
                        <div>
                            ...
                            <Button size='sm' onClick={() => sendAddress(input)} disabled={!rollups}>
                                Relay Address
                            </Button>
                            <br /><br />
                        </div>
